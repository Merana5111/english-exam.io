const questions = [
    {
        question:`We haven't got much time. We <span class="line"></span> hurry.`,
        answers: [
    ...
    {
        question:`I <span class="line"></span> run 5 kilometers without stopping when I was younger.`,
        answers: [
    ...
    {
        question:`She <span class="line"></span> be at work by 9 AM every day.`,
        answers: [
            {text : "can", correct: false},
    ...
    {
        question:`We <span class="line"></span> see a movie tonight if you want.`,
        answers: [
            {text : "have to", correct: false},
            {text : "can't", correct: false},
            {text : "could", correct: true},
    ...
    {
        question:`He <span class="line"></span> fix the car himself; it needs to be done.`,
        answers: [
    ...
    {
        question:`You <span class="line"></span> eat junk food every day; it's not healthy.`,
        answers: [
    ...
    {
        question:`I <span class="line"></span> finish this report by tomorrow.`,
        answers: [
            {text : "have to", correct: false},
            {text : "could", correct: false},
            {text : "can", correct: false},
    ...
    {
        question:`She <span class="line"></span> swim when she was five years old.`,
        answers: [
            {text : "have to", correct: false},
            {text : "can't", correct: false},
            {text : "must", correct: false},
    ...
    {
        question:`You <span class="line"></span> wear a helmet when riding a bike.`,
        answers: [
            {text : "could", correct: false},
            {text : "can", correct: false},
            {text : "must", correct: true},
    ...
    {
        question:`They <span class="line"></span> help us if they have time.`,
        answers: [
            {text : "have to", correct: false},
            {text : "must", correct: false},
            {text : "could", correct: true},
