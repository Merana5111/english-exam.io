const questions = [
    {
        question:`<span class="line"></span> chairs are in the classroom?`,
        answers: [
    ...
    {
        question:`How <span class="line"></span> free time have you got during the week?`,
        answers: [
    ...
    {
        question:`Have you got <span class="line"></span> close friends at school?`,
        answers: [
    ...
    {
        question:`I'm not very busy tonight. I haven't got <span class="line"></span> homework for tomorrow.`,
        answers: [
            {text : "much", correct: true},
            {text : "many", correct: false},
    ...
    {
        question:`I don't like this room because there isn't <span class="line"></span> window.`,
        answers: [
            {text : "much", correct: false},
            {text : "many", correct: false},
    ...
    {
        question:`Hurry up! We haven't got so <span class="line"></span> time.`,
        answers: [
            {text : "a", correct: false},
            {text : "many", correct: false},
            {text : "an", correct: false},
    ...
    {
        question:`The school is nearly empty. There aren't <span class="line"></span> students at school.`,
        answers: [
            {text : "few", correct: false},
    ...
    {
        question:`How <span class="line"></span> boys <span class="line"></span> there at the party?`,
        answers: [
            {text : "much / is", correct: false},
            {text : "much / are", correct: false},
            {text : "many / is", correct: false},
            {text : "many / are", correct: true},
        ]
    },
    {
        question:`There isn't <span class="line"></span> traffic so we aren't late.`,
        answers: [
            {text : "an", correct: false},
            {text : "many", correct: false},
            {text : "much", correct: true},
    ...
    {
        question:`How <span class="line"></span> money is there in your pocket?`,
        answers: [
            {text : "many", correct: false},
...
Студент: ${studentName}
Тест: English How Much How Many Quiz
