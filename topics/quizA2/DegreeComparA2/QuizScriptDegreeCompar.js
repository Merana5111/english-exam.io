const questions = [
    {
        question:`The building is <span class="line"></span> that building.`,
        answers: [
            {text : "taller than", correct: true},
            {text : "tall than", correct: false},
            {text : "taller", correct: false},
            {text : "the tallest", correct: false},
        ]
    },
    {
        question:`The story is very <span class="line"></span>.`,
        answers: [
            {text : "longer", correct: false},
            {text : "the longest", correct: false},
            {text : "long", correct: true},
            {text : "the longer", correct: false},
        ]
    },
    {
        question:`Our neighbour's car is <span class="line"></span> than ours.`,
        answers: [
            {text : "old", correct: false},
            {text : "older", correct: true},
            {text : "the oldest", correct: false},
            {text : "older than", correct: false},
        ]
    },
    {
        question:`This question is <span class="line"></span> one in the entire test.`,
        answers: [
            {text : "difficultest", correct: false},
            {text : "more difficult", correct: false},
            {text : "difficult", correct: false},
            {text : "the most difficult", correct: true},
        ]
    },
    {
        question:`This box is <span class="line"></span> one of all the boxes on the truck.`,
        answers: [
    ...
    {
        question:`I am <span class="line"></span> than you may think.`,
        answers: [
            {text : "the happiest", correct: false},
    ...
    {
        question:`People are much <span class="line"></span> here than at our previous location.`,
        answers: [
            {text : "friend", correct: false},
            {text : "the friendliest", correct: false},
            {text : "friendly", correct: false},
            {text : "friendlier", correct: true},
        ]
    },
    {
        question:`Margo is a very <span class="line"></span> boys <span class="line"></span> girl.`,
        answers: [
            {text : "the politest", correct: false},
            {text : "polite", correct: true},
            {text : "more polite", correct: false},
            {text : "the most polite", correct: false},
        ]
    },
    {
        question:`This pizza is quite <span class="line"></span>.`,
        answers: [
            {text : "tasty", correct: true},
            {text : "tastier", correct: false},
            {text : "the tastiest", correct: false},
            {text : "more tasty", correct: false},
        ]
    },
    {
        question:`Paul is <span class="line"></span> than his friend.`,
        answers: [
            {text : "tall", correct: false},
            {text : "taller", correct: true},
            {text : "the taller", correct: false},
            {text : "taller than", correct: false},
        ]
    }
];
...
showScore = function() {
    ...
    sendResultsBtn.innerHTML = 'Send result';
...
Студент: ${studentName}
Тест: English Degree of Comparisons Quiz
