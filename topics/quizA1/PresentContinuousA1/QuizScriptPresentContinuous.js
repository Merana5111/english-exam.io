const questions = [
    {
        question:`I <span class="line"></span> to the city center.`,
        answers: [
            {text : "am driving", correct: true},
            {text : "is driving", correct: false},
            {text : "are driving", correct: false},
            {text : "driving", correct: false},
        ]
    },
    {
        question:`He <span class="line"></span> to music now.`,
        answers: [
            {text : "are listening", correct: false},
            {text : "is listening", correct: true},
            {text : "am listening", correct: false},
            {text : "listening", correct: false},
        ]
    },
    {
        question:`Why <span class="line"></span> going with us tomorrow?`,
        answers: [
            {text : "aren't you", correct: true},
            {text : "not are you", correct: false},
            {text : "you not are", correct: false},
            {text : "you aren't", correct: false},
        ]
    },
    {
        question:`What <span class="line"></span> today?`,
        answers: [
            {text : "are they wear", correct: false},
            {text : "they wear", correct: false},
            {text : "they are wearing", correct: false},
            {text : "are they wearing", correct: true},
        ]
    },
    {
        question:`Mike is in the bathroom. He <span class="line"></span> a shower.`,
        answers: [
            {text : "taking", correct: false},
            {text : "takes", correct: false},
            {text : "is taking", correct: true},
            {text : "are taking", correct: false},
        ]
    },
    {
        question: `Why is she in the garden? What <span class="line"></span> there?`,
        answers: [
            {text : "she is doing", correct: false},
            {text : "she doing", correct: false},
            {text : "is she doing", correct: true},
            {text : "she does", correct: false},
        ]
    },
    {
        question:`We <span class="line"></span> now. We've finished.`,
        answers: [
            {text : "not exercise", correct: false},
            {text : "aren't exercising", correct: true},
            {text : "not exercising", correct: false},
            {text : "isn't exercising", correct: false},
        ]
    },
    {
        question:`Mary <span class="line"></span> a French book.`,
        answers: [
    ...
    {
        question:`Why <span class="line"></span>?`,
        answers: [
            {text : "are you crying", correct: true},
            {text : "are you criing", correct: false},
            {text : "you cry", correct: false},
            {text : "you crying", correct: false},
        ]
    },
    {
        question:`They are not at home. They <span class="line"></span> out.`,
        answers: [
            {text : "is eating", correct: false},
