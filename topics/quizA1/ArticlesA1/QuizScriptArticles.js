const questions = [
    {
        question:`It's <span class="line"></span> interesting book.`,
        answers: [
            {text : "-", correct: false},
    ...
    {
        question:`I don't have <span class="line"></span> car.`,
        answers: [
            {text : "the", correct: false},
            {text : "a", correct: true},
    ...
    {
        question:`<span class="line"></span> president visited our school.`,
        answers: [
    ...
    {
        question:`Can you pass me <span class="line"></span> water.`,
        answers: [
            {text : "a", correct: false},
            {text : "an", correct: false},
            {text : "-", correct: false},
    ...
    {
        question:`My father is <span class="line"></span> police officer.`,
        answers: [
            {text : "a", correct: true},
            {text : "the", correct: false},
            {text : "-", correct: false},
    ...
    {
        question: `She picked me up at <span class="line"></span> airport.`,
        answers: [
            {text : "-", correct: false},
            {text : "an", correct: false},
            {text : "a", correct: false},
    ...
    {
        question:`Children likes <span class="line"></span> sweets.`,
        answers: [
            {text : "-", correct: true},
            {text : "a", correct: false},
            {text : "the", correct: false},
    ...
    {
        question:`Do you want <span class="line"></span> orange?`,
        answers: [
            {text : "a", correct: false},
            {text : "an", correct: true},
            {text : "the", correct: false},
    ...
    {
        question:`The test results will be available in just haif <span class="line"></span> hour.`,
        answers: [
            {text : "a", correct: false},
            {text : "an", correct: true},
            {text : "the", correct: false},
    ...
    {
        question:`These are our <span class="line"></span> cars.`,
        answers: [
            {text : "a", correct: false},
            {text : "-", correct: true},
            {text : "an", correct: false},
