const questions = [
    {
        question:`John often <span class="line"></span> handball.`,
        answers: [
            {text : "play", correct: false},
            {text : "plays", correct: true},
            {text : "played", correct: false},
            {text : "playes", correct: false},
        ]
    },
    {
        question:`Mandy and Susan <span class="line"></span> films every weekend.`,
        answers: [
    ...
    {
        question:`Do you <span class="line"></span> milk in your tea?`,
        answers: [
            {text : "likes", correct: false},
            {text : "liks", correct: false},
            {text : "liked", correct: false},
            {text : "like", correct: true},
        ]
    },
    {
        question:`I <span class="line"></span> my homework every day.`,
        answers: [
    ...
    {
        question:`I sometimes <span class="line"></span> to school.`,
        answers: [
            {text : "walks", correct: false},
            {text : "walkes", correct: false},
            {text : "walked", correct: false},
            {text : "walk", correct: true},
        ]
    },
    {
        question: `Sue rarely <span class="line"></span> coffee.`,
        answers: [
    ...
    {
        question:`The baby <span class="line"></span> every night.`,
        answers: [
            {text : "cries", correct: true},
    ...
    {
        question:`Jose and I <span class="line"></span> chemistry together every week.`,
        answers: [
            {text : "studies", correct: false},
            {text : "studis", correct: false},
            {text : "study", correct: true},
            {text : "studying", correct: false},
        ]
    },
    {
        question:`Her aunt <span class="line"></span> English.`,
        answers: [
            {text : "teach", correct: false},
            {text : "teachs", correct: false},
            {text : "teaching", correct: false},
            {text : "teaches", correct: true},
        ]
    },
    {
        question:`I <span class="line"></span> volleyball every day.`,
        answers: [
            {text : "don't play", correct: true},
            {text : "didn't play", correct: false},
            {text : "weren't playing", correct: false},
            {text : "don't plays", correct: false},
        ]
    }
];
