const questions = [
    {
        question:`<span class="line"></span> your children here? No, they <span class="line"></span>.`,
        answers: [
            {text : "Are, are", correct: false},
            {text : "Is, aren't", correct: false},
            {text : "Are, aren't", correct: true},
            {text : "Is, isn't", correct: false},
        ]
    },
    {
        question:`<span class="line"></span> it Saturday today? No, It <span class="line"></span> Sunday.`,
        answers: [
            {text : "Is, is", correct: true},
            {text : "Are, aren't", correct: false},
            {text : "Is, isn't", correct: false},
            {text : "Are, are", correct: false},
        ]
    },
    {
        question:`How old <span class="line"></span> Peter? I think he <span class="line"></span> 30 years old.`,
        answers: [
            {text : "is, are", correct: false},
            {text : "are, is", correct: false},
            {text : "is, is", correct: true},
            {text : "are, are", correct: false},
        ]
    },
    {
        question:`<span class="line"></span> you hungry? No, I <span class="line"></span> not.`,
        answers: [
            {text : "Are, is", correct: false},
            {text : "Are, am", correct: true},
            {text : "Is, am", correct: false},
            {text : "Am, am", correct: false},
        ]
    },
    {
        question:`Katy's parents <span class="line"></span> doctors.`,
        answers: [
    ...
    {
        question:`My books <span class="line"></span> new.`,
        answers: [
            {text : "is", correct: false},
            {text : "was", correct: false},
            {text : "am", correct: false},
    ...
    {
        question:`My son <span class="line"></span> short in school, but now he <span class="line"></span> tall.`,
        answers: [
            {text : "was, is", correct: true},
            {text : "are, was", correct: false},
            {text : "is, is", correct: false},
            {text : "were, is", correct: false},
        ]
    },
    {
        question:`The weather <span class="line"></span> nice today, but it <span class="line"></span> horrible last weekend.`,
        answers: [
            {text : "are, were", correct: false},
            {text : "is, was", correct: true},
            {text : "is, is", correct: false},
            {text : "was, is", correct: false},
        ]
    },
    {
        question:`<span class="line"></span> you at the beach last Sunday? Yes, I <span class="line"></span>.`,
        answers: [
            {text : "Is, am", correct: false},
            {text : "Are, is", correct: false},
            {text : "Was, were", correct: false},
            {text : "Were, was", correct: true},
        ]
    },
    {
        question:`She <span class="line"></span> sad yesterday.`,
        answers: [
