const questions = [
    {
        question:`This is Berta. <span class="line"></span> likes ice-cream.`,
        answers: [
    ...
    {
        question:`My friend and I study English. <span class="line"></span> have classes every week.`,
        answers: [
            {text : "They", correct: false},
            {text : "He", correct: false},
    ...
    {
        question:`Look at John. <span class="line"></span> is very tall.`,
        answers: [
    ...
    {
        question:`Eric and Ken are brothers. <span class="line"></span> are 4 and 10 years old.`,
        answers: [
    ...
    {
        question:`Look at that cat! <span class="line"></span> is so fat!`,
        answers: [
            {text : "He", correct: false},
            {text : "She", correct: false},
    ...
    {
        question: `My name's Bill. <span class="line"></span> am 9 years old.`,
        answers: [
            {text : "I", correct: true},
            {text : "They", correct: false},
            {text : "She", correct: false},
    ...
    {
        question:`This is Mr.Tompson. <span class="line"></span> is my teacher.`,
        answers: [
            {text : "They", correct: false},
            {text : "He", correct: true},
            {text : "It", correct: false},
    ...
    {
        question:`Mike is a sportsman. <span class="line"></span> runs very fast.`,
        answers: [
            {text : "He", correct: true},
            {text : "It", correct: false},
            {text : "I", correct: false},
    ...
    {
        question:`Do you know Alice? <span class="line"></span> is my friend.`,
        answers: [
            {text : "He", correct: false},
            {text : "You", correct: false},
            {text : "She", correct: true},
    ...
    {
        question:`This is Ben. <span class="line"></span> is my brother.`,
        answers: [
            {text : "We", correct: false},
            {text : "She", correct: false},
            {text : "I", correct: false},
...
Студент: ${studentName}
Тест: English Personal Pronouns Quiz
