const questions = [
    ...
    {
        question:`What's the plural of "sheep"?`,
        answers: [
            {text : "Sheeps", correct: false},
            {text : "Ship", correct: false},
            {text : "Sheepes", correct: false},
            {text : "Sheep", correct: true},
        ]
    },
    {
        question:`What's the plural of "potato"?`,
        answers: [
            {text : "Potatos", correct: false},
            {text : "Potatoes", correct: true},
            {text : "Potats", correct: false},
            {text : "None of these", correct: false},
        ]
    },
    {
        question:`What's the plural of "woman"?`,
        answers: [
            {text : "Womans", correct: false},
            {text : "Womanes", correct: false},
            {text : "Women", correct: true},
            {text : "None of these", correct: false},
        ]
    },
    {
        question:`What's the plural of "mouse"?`,
        answers: [
            {text : "Mice", correct: true},
            {text : "Mouses", correct: false},
            {text : "Mousies", correct: false},
            {text : "None of these", correct: false},
        ]
    },
    {
        question: `What's the plural of "wife"?`,
        answers: [
            {text : "Wifes", correct: false},
            {text : "Wifies", correct: false},
            {text : "Wify", correct: false},
            {text : "Wives", correct: true},
        ]
    },
    {
        question:`What's the plural of "book"?`,
        answers: [
            {text : "Bookies", correct: false},
    ...
    {
        question:`What's the plural of "knife"?`,
        answers: [
            {text : "Knifes", correct: false},
            {text : "Knifies", correct: false},
            {text : "Knives", correct: true},
            {text : "Knivs", correct: false},
        ]
    },
    {
    ...
    {
        question:`What's the plural of "lady"?`,
        answers: [
            {text : "Ladys", correct: false},
            {text : "Ladyes", correct: false},
            {text : "Ladies", correct: true},
...
Студент: ${studentName}
Тест: English Plural Singular Quiz
