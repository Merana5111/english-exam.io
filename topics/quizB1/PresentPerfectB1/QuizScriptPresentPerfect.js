const questions = [
    {
        question:`<span class="line"></span> to Rome?`,
        answers: [
            {text : "Have ever you been", correct: false},
            {text : "Have you ever been", correct: true},
            {text : "Have you been ever", correct: false},
            {text : "Have been you ever", correct: false},
        ]
    },
    {
        question:`I <span class="line"></span> the keys that I lose yet.`,
        answers: [
    ...
    {
        question:`I <span class="line"></span> Peter since I was 5 years old.`,
        answers: [
            {text : "'ve know", correct: false},
    ...
    {
        question:`I <span class="line"></span> my pen. Can I use yours?`,
        answers: [
            {text : "have lost", correct: true},
            {text : "have losed", correct: false},
            {text : "lose", correct: false},
            {text : "have lose", correct: false},
        ]
    },
    {
        question:`We <span class="line"></span> insects before.`,
        answers: [
            {text : "never have ate", correct: false},
            {text : "have never eaten", correct: true},
            {text : "never have eaten", correct: false},
            {text : "have never ate", correct: false},
        ]
    },
    {
        question:`<span class="line"></span> raining yet?`,
        answers: [
            {text : "Has it stop", correct: false},
            {text : "Does it stopped", correct: false},
            {text : "Has it stopped", correct: false},
            {text : "Have it stop", correct: true},
        ]
    },
    {
        question:`He <span class="line"></span> his keys.`,
        answers: [
            {text : "have lose", correct: false},
            {text : "has lost", correct: true},
            {text : "has lose", correct: false},
            {text : "have lost", correct: false},
        ]
    },
    {
        question:`She <span class="line"></span> to us.`,
        answers: [
            {text : "never have lied", correct: false},
            {text : "never has lied", correct: false},
            {text : "have never lied", correct: false},
            {text : "has never lied", correct: true},
        ]
    },
    {
        question:`We <span class="line"></span> to England many times.`,
        answers: [
    ...
    {
        question:`David <span class="line"></span> the competition.`,
        answers: [
            {text : "won", correct: false},
            {text : "have won", correct: false},
            {text : "has won", correct: true},
            {text : "has win", correct: false},
        ]
    }
];
