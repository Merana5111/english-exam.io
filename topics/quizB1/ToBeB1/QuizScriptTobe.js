const questions = [
    {
        question:`But they <span class="line"></span> after us now.`,
        answers: [
    ...
    {
        question:`They <span class="line"></span> only great as they <span class="line"></span> good.`,
        answers: [
            {text : "are / are", correct: true},
    ...
    {
        question:`They <span class="line"></span> a both young, you <span class="line"></span> know.`,
        answers: [
            {text : "- / -", correct: false},
            {text : "are / -", correct: true},
    ...
    {
        question:`That <span class="line"></span> the way we <span class="line"></span> made.`,
        answers: [
            {text : "are / -", correct: false},
            {text : "are / are", correct: false},
            {text : "- / are", correct: false},
            {text : "is / are", correct: true},
        ]
    },
    {
        question:`They <span class="line"></span> know what you <span class="line"></span> after.`,
        answers: [
            {text : "- / are", correct: true},
            {text : "are / -", correct: false},
            {text : "are / are", correct: false},
    ...
    {
        question:`If he <span class="line"></span>, we <span class="line"></span> not.`,
        answers: [
            {text : "- / -", correct: false},
            {text : "- / are", correct: false},
            {text : "is / are", correct: true},
    ...
    {
        question:`It <span class="line"></span> well that it <span class="line"></span> so.`,
        answers: [
            {text : "- / is", correct: false},
    ...
    {
        question:`And we <span class="line"></span> going into another world.`,
        answers: [
    ...
    {
        question:`They <span class="line"></span> know that I <span class="line"></span> with you.`,
        answers: [
    ...
    {
        question:`He <span class="line"></span> in the day and the night.`,
        answers: [
            {text : "am", correct: false},
            {text : "-", correct: false},
            {text : "are", correct: false},
