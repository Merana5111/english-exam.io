const questions = [
    {
        question:`Her mother <span class="line"></span> when she <span class="line"></span> 15.`,
        answers: [
            {text : "die / was", correct: false},
            {text : "died / was", correct: true},
            {text : "die / is", correct: false},
            {text : "died / is", correct: false},
        ]
    },
    {
        question:`My father lived there when he <span class="line"></span>.`,
        answers: [
            {text : "meets my mother", correct: false},
            {text : "were a kid", correct: false},
            {text : "meeting my mother", correct: false},
            {text : "was a kid", correct: true},
        ]
    },
    {
        question:`The bullet <span class="line"></span> past his head.`,
        answers: [
    ...
    {
        question:`He <span class="line"></span> to me when he was younger.`,
        answers: [
            {text : "didn't lie", correct: true},
            {text : "didn't never lie", correct: false},
            {text : "never lie", correct: false},
            {text : "don't never lie", correct: false},
        ]
    },
    {
        question:`All of a sudden, he <span class="line"></span> the ball.`,
        answers: [
            {text : "dropd", correct: false},
    ...
    {
        question:`She never <span class="line"></span> alone.`,
        answers: [
            {text : "don't stay", correct: false},
            {text : "stayed", correct: true},
            {text : "not stayed", correct: false},
            {text : "didn't stay", correct: false},
        ]
    },
    {
        question:`Sarah <span class="line"></span> her cup of coffee back to her desk.`,
        answers: [
            {text : "carried", correct: true},
            {text : "carry", correct: false},
            {text : "carryed", correct: false},
            {text : "don't carry", correct: false},
        ]
    },
    {
        question:`Where <span class="line"></span> last summer?`,
        answers: [
            {text : "do you want", correct: false},
            {text : "you went", correct: false},
            {text : "did you went", correct: false},
            {text : "did you go", correct: true},
        ]
    },
    {
        question:`Tom <span class="line"></span> a timid teenager ten years ago.`,
        answers: [
    ...
    {
        question:`How many books <span class="line"></span> you <span class="line"></span> last year?`,
        answers: [
            {text : "does / read", correct: false},
            {text : "did / read", correct: true},
            {text : "do / read", correct: false},
            {text : "did / readed", correct: false},
        ]
    }
];
