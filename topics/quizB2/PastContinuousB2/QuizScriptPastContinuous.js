const questions = [
    {
        question:`Last night I <span class="line"></span> on my thesis and it took me a while to realise that my phone was ringning.`,
        answers: [
            {text : "worked", correct: false},
            {text : "was working", correct: true},
            {text : "were working", correct: false},
            {text : "working", correct: false},
        ]
    },
    {
        question:`Why did you disagree with me at the meeting? <span class="line"></span> to make me look incompetent?`,
        answers: [
            {text : "You was trying", correct: false},
            {text : "You were trying", correct: false},
            {text : "Was you trying", correct: false},
            {text : "Were you trying", correct: true},
        ]
    },
    {
        question:`Sarah <span class="line"></span> the buffet while I was seeing to the drinks.`,
        answers: [
            {text : "preparing", correct: false},
            {text : "were preparing", correct: false},
            {text : "was preparing", correct: true},
            {text : "prepared", correct: false},
        ]
    },
    {
        question:`Peter <span class="line"></span> home when the accident occurred.`,
        answers: [
    ...
    {
        question:`Anna <span class="line"></span> her speech when I walked in.`,
        answers: [
            {text : "finished", correct: false},
            {text : "finishing", correct: false},
            {text : "was finishing", correct: true},
            {text : "were finishing", correct: false},
        ]
    },
    {
        question:`My sister <span class="line"></span> a Royal Enfield yesterday.`,
        answers: [
            {text : "is riding", correct: false},
            {text : "was riding", correct: true},
            {text : "were riding", correct: false},
            {text : "riding", correct: false},
        ]
    },
    {
        question:`The dogs <span class="line"></span> all night.`,
        answers: [
            {text : "is barking", correct: false},
            {text : "barking", correct: false},
            {text : "was barking", correct: false},
            {text : "were barking", correct: true},
        ]
    },
    {
        question:`There children <span class="line"></span> hide and seek in the park.`,
        answers: [
            {text : "were playng", correct: false},
            {text : "were playing", correct: true},
            {text : "was playing", correct: false},
            {text : "playing", correct: false},
        ]
    },
    {
        question:`The army <span class="line"></span> to Ladakh when the enemy attacked them.`,
        answers: [
            {text : "was going", correct: true},
    ...
    {
        question:`I <span class="line"></span> the book you gave me on my birthday.`,
        answers: [
            {text : "was reading", correct: true},
            {text : "were reading", correct: false},
            {text : "reading", correct: false},
            {text : "was reading to", correct: false},
        ]
    }
];
